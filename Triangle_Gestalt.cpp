...
//
//	<삼각형 형태 알아내기>
//		1. 꼭짓점 3개의 좌표를 입력받아서 직각삼각형인지(1 출력), 둔각삼각형인지(2 출력), 예각삼각형인지(3 출력), 삼각형이 되지 않는지(0) 출력
//
...
public:
	...
	int Check()
	{
		if (Triangle1.first == Triangle1.first && Triangle1.second == Triangle2.second ||
			...
			abs(Triangle1.first - Triangle1.second) == abs(Triangle2.first - Triangle2.second) == abs(Triangle3.first - Triangle3.second))
			return 0;
